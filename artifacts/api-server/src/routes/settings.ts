...
const ALLOWED_KEYS = new Set(["OPENAI_API_KEY", "ELEVENLABS_API_KEY", "XAI_API_KEY", "PEXELS_API_KEY", "YOUTUBE_API_KEY", "GEMINI_API_KEY", "ELEVENLABS_VOICE_ID", "GEMINI_VOICE_NAME", "CHANNEL_NAME", "CHANNEL_INTRO", "TTS_ENGINE", "TTS_SPEED"]);
const NON_SECRET_KEYS = new Set(["ELEVENLABS_VOICE_ID", "GEMINI_VOICE_NAME", "CHANNEL_NAME", "CHANNEL_INTRO", "TTS_ENGINE", "TTS_SPEED"]);
